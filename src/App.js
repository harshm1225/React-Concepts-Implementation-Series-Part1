...
function App() {
  ...
  function submitClickHandler(event) {
    ...
    if (!btnClicked) {
      console.log(
        cardWrapper.previousElementSibling.firstChild.classList.add("show")
      );
      return;
    }
    ...
    const userSelectedRating = [
      ...event.target.previousElementSibling.children,
    ].filter((btn) => {
      return btn.classList.contains("selected") ? btn : "";
    })[0].innerText;
    reviewRating = Number(userSelectedRating);
    cardWrapper1.classList.toggle("hidden");
    cardWrapper2.classList.toggle("hidden");
    ratingText.innerText = "You have selected " + reviewRating + " out of 5";
    const informUserText = "This is my first React mini project!🚀🧑‍💻";
    setTimeout(() => {
      cardWrapper.previousElementSibling.firstChild.innerText = informUserText;
      cardWrapper.previousElementSibling.firstChild.classList.add("show");
    }, 3000);
  }
  ...
  function buttonClickHandler(event) {
    ...
    cardWrapper.previousElementSibling.firstChild.classList.remove("show");
  }
  return (
    <div className="container">
      ...
      <div className="card-wrapper">
        <div className="card-wrapper-1">
          ...
          <div className="button-container" onClick={buttonClickHandler}>
        ...
        <div className="card-wrapper-2 hidden">
